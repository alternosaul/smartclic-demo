...
export function PortfolioServicesGrid() {
  ...
  return (
    <div className="w-full lg:max-w-xs">
      ...
      <ul className="mt-4 grid grid-cols-1 gap-2.5 sm:auto-rows-fr sm:grid-cols-2 sm:items-stretch sm:gap-3 lg:grid-cols-1 lg:gap-2.5">
        {items.map((item, i) => {
          ...
          return (
            ...
            >
              <button
                ...
                className={cn(
                  'flex h-full w-full items-start gap-2.5 rounded-xl border p-2.5 text-left transition-all duration-500 sm:gap-3 sm:p-3',
                  isActive
